...
Note - Some sessions are part of a thematic series, but each session stands on its own. You’re welcome to attend any session, even if you haven’t attended earlier ones.
...
*Prerequisites*: Attendees will need an active Roar account. To request Roar access, please complete the [Account Request form](https://accounts.hpc.psu.edu/users/#) by Tuesday, August 12, 2025.
...
- [HTML talk slides](https://penn-state-open-science.github.io/bootcamp-2025-quarto-I/)
